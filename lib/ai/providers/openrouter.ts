...
const FREE_OPENROUTER_MODELS: AIModelInfo[] = [
  {
    ...
    provider: 'Meta',
    description: "Meta's highly capable open model, comparable to GPT-4 class models. Excellent for complex tasks.",
  ...
  },
  {
    ...
    provider: 'Google',
    description: "Google's latest experimental multimodal model. Fast and capable, but may be rate-limited.",
  ...
  },
  {
    ...
    provider: 'Google',
    description: "Google's latest open model, offering improved math, reasoning, and chat capabilities.",
  ...
  },
  {
    ...
    provider: 'Qwen',
    description: "A capable multimodal model from Alibaba Cloud, good for visual understanding and general text.",
