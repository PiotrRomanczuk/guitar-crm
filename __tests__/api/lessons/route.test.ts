	...
	describe('GET /api/lessons', () => {
		...
		it('should filter lessons by userId', async () => {
			...
			const request = new NextRequest(
				'http://localhost:3000/api/lessons?userId=student-456'
			);
			const response = await GET(request);
			const data = await response.json();
		...
		it('should filter lessons by status', async () => {
			...
			const request = new NextRequest(
				'http://localhost:3000/api/lessons?filter=SCHEDULED'
			);
			const response = await GET(request);
			const data = await response.json();
		...
		it('should return error for invalid status filter', async () => {
			const request = new NextRequest(
				'http://localhost:3000/api/lessons?filter=INVALID_STATUS'
			);
			const response = await GET(request);
			const data = await response.json();
		...
		it('should sort lessons by date', async () => {
			...
			const request = new NextRequest(
				'http://localhost:3000/api/lessons?sort=date'
			);
			const response = await GET(request);
		...
		it('should return error for invalid studentId format', async () => {
			const request = new NextRequest(
				'http://localhost:3000/api/lessons?studentId=invalid-uuid'
			);
			const response = await GET(request);
			const data = await response.json();
