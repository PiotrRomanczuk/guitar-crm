...
- **UI Library**: ShadCN UI implementation, customization, and extension
...
2. **Leverage ShadCN UI**: Prioritize using ShadCN components for new UI elements before building from scratch
