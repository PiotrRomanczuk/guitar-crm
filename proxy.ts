...
// Note: This file provides a helper for request-time session sync when invoked.
// It is not registered as Next.js middleware; auth guarding is handled in layout/pages.
