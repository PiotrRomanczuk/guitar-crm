...
describe('Password Reset Flow', () => {
  ...
  describe('Request Password Reset', () => {
    ...
    it('should submit password reset request successfully', () => {
      ...
      cy.contains(/check your email|reset link sent|email sent/i, { timeout: 10000 })
        .should('be.visible')
    })
    ...
    it('should handle non-existent email gracefully', () => {
      ...
      cy.contains(/check your email|reset link sent/i, { timeout: 10000 })
        .should('be.visible')
    })
  })
  ...
  describe('Security Features', () => {
    it('should require token in URL', () => {
      ...
      cy.get('body').then($body => {
        const hasError = $body.find(':contains("Invalid"), :contains("token"), :contains("expired")').length > 0
