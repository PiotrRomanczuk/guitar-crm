    ...
    it('should see all students in student list', () => {
      ...
      cy.get('body').then($body => {
        const hasAdminControls = 
          $body.find('button:contains("Add"), button:contains("New"), [data-testid*="add"]').length > 0
    ...
    it('should create and manage resources', () => {
      ...
      cy.get('body').then($body => {
        const hasCreateButton = 
          $body.find('button:contains("New"), button:contains("Add"), button:contains("Create")').length > 0
