...
describe('Admin Lesson Management', () => {
  ...
  it('should create a new lesson', () => {
    ...
    cy.get('[data-testid="lesson-start-time"]').type('14:00');
  ...
  it('should edit an existing lesson', () => {
    ...
    cy.visit('/dashboard/lessons/new');
    cy.get('[data-testid="lesson-date"]').type('2025-12-02');
    cy.get('[data-testid="lesson-start-time"]').type('10:00');
    ...
    cy.get('[data-testid="lesson-date"]').clear().type(newDate);
    cy.get('[data-testid="lesson-start-time"]').clear().type(newTime);
