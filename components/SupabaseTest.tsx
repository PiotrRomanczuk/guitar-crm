...
export default function SupabaseTest() {
	...
	if (loading) return (
		<div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
			<div className="text-center">
				...
				<p className="text-gray-600 dark:text-gray-300">Loading Supabase connection...</p>
			</div>
		</div>
	);
	...
	if (error) return (
		<div className="p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
			<h2 className="text-2xl font-bold mb-4 text-red-800 dark:text-red-200">Supabase Connection Status</h2>
			<div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-4">
				<p className="text-yellow-800 dark:text-yellow-200 font-semibold">⚠️ Configuration Required</p>
				<p className="text-yellow-700 dark:text-yellow-300 mt-2">{error}</p>
			</div>
			<div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
				<p className="text-blue-800 dark:text-blue-200 font-semibold">Next Steps:</p>
