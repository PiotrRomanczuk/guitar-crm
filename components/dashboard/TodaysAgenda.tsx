          ...
          <div className="flex items-start justify-between gap-2">
            ...
            <Link href="/dashboard/lessons">
              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <Button size="sm" variant="ghost" className="h-8 w-8 sm:h-9 sm:w-9 p-0 min-h-[44px] min-w-[44px]">
        ...
        <CardContent className="space-y-3 sm:space-y-4 px-3 sm:px-6 pb-3 sm:pb-6">
          ...
          >
            <motion.div
              ...
              className="text-center p-1.5 sm:p-2 rounded-md bg-blue-500/10"
            >
            ...
            <motion.div
              variants={listItem}
              whileHover={{ scale: 1.05 }}
              className="text-center p-1.5 sm:p-2 rounded-md bg-green-500/10"
            >
            ...
            <motion.div
              variants={listItem}
              whileHover={{ scale: 1.05 }}
              className="text-center p-1.5 sm:p-2 rounded-md bg-red-500/10"
            >
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="space-y-2 max-h-100 overflow-y-auto"
          >
            {todayItems.length === 0 ? (
              <motion.div
              ...
              >
                <motion.div
                  ...
                  className="w-12 h-12 rounded-full bg-muted mx-auto mb-2 flex items-center justify-center"
                >
                ...
                {todayItems.map((item) => {
                  ...
                  return (
                    <motion.div
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="p-2.5 rounded-lg border border-border hover:bg-muted/50 transition-colors cursor-pointer min-h-[56px]"
                    >
