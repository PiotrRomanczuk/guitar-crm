    ...
    <form onSubmit={handleSubmit} className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <TextInput
          ...
          error={errors.email}
          placeholder={
            formData.isShadow ? 'Email optional for shadow users' : 'Enter email address'
          }
      ...
      <UserFormActions mode={mode} loading={loading} onCancel={onCancel} />
    </form>
  );
}
