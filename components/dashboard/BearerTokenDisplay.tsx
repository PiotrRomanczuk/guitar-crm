			...
			{loading ? (
				...
				<div className='space-y-3'>
					...
					<p className='text-xs text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 p-2 rounded'>
						⚠️ Keep this token secret! Never share it publicly. Use it in the Authorization header: <code className='font-mono'>Authorization: Bearer &lt;token&gt;</code>
					</p>
				</div>
			) : (
				<div className='space-y-3'>
					...
					<p className='text-xs text-gray-500 dark:text-gray-400'>
						You can manage multiple tokens in your <a href='/settings' className='text-blue-600 dark:text-blue-400 hover:underline'>settings</a>.
					</p>
				</div>
			)}
		</div>
