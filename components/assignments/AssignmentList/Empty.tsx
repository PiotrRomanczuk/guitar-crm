...
export function Empty() {
  return (
    ...
    >
      <div
        className="w-12 h-12 sm:w-16 sm:h-16 mb-3 sm:mb-4 rounded-full 
      ...
      <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 max-w-sm">
        Assignments will appear here once they are created. Teachers can create new assignments for
        their students.
      </p>
    </div>
  );
