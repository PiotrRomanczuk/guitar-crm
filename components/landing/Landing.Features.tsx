...
function FeatureCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl border border-[#3a2e22] bg-[#221b10] p-8 transition-all hover:border-[#ec9c13]/50 hover:shadow-xl hover:shadow-[#ec9c13]/5 hover:-translate-y-1">
      ...
      <div className="relative z-10 flex flex-col items-start gap-6 h-full">
        {/* Icon */}
        <div className="p-4 rounded-xl bg-[#2e261d] text-[#ec9c13] border border-[#3a2e22] shadow-inner group-hover:bg-[#3a2e22] transition-colors">
        ...
        <div className="flex-1">
          ...
          <p className="text-[#b9af9d] leading-relaxed">{description}</p>
        </div>

        {/* Link */}
        <Link
          href="#"
          className="inline-flex items-center text-[#ec9c13] font-bold text-sm hover:text-amber-300 mt-auto"
        >
          Learn more
...
export function LandingFeatures() {
  return (
    <section id="features" className="px-6 lg:px-8 py-20 bg-[#181511] flex flex-col gap-12 items-center">
      {/* Header */}
      <div className="flex flex-col gap-3 text-center max-w-3xl">
        <h3 className="text-4xl font-bold text-white">Crafted Features</h3>
        <p className="text-[#b9af9d] text-lg">
