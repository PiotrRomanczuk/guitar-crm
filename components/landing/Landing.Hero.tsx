    ...
    <section className="relative min-h-[700px] w-full flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-6 max-w-2xl py-20">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#ec9c13]/20 border border-[#ec9c13]/30 w-fit backdrop-blur-sm">
            <span className="w-2 h-2 rounded-full bg-[#ec9c13] animate-pulse" />
            <span className="text-sm font-bold text-[#ec9c13] uppercase tracking-wide">
              New: Tab Editor
            </span>
          </div>

          {/* Heading */}
          <h2 className="text-5xl lg:text-7xl font-extrabold text-white leading-[1.1] tracking-tight drop-shadow-sm">
            Elevate Your <br />
            <span className="text-[#ec9c13]">Guitar Teaching</span>
          </h2>
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-4">
            ...
            <Button
              variant="outline"
              className="h-14 px-8 border border-[#3a2e22] hover:border-[#ec9c13]/50 bg-[#221b10]/50 text-white font-bold text-lg rounded-lg backdrop-blur-sm transition-colors"
            >
              View Demo
            </Button>
          </div>
          ...
          {/* Trust text */}
          <p className="text-sm text-[#b9af9d] mt-2">
