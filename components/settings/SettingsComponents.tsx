  ...
  return (
    <div className="space-y-2">
      ...
      <select
        ...
        disabled={disabled}
        className="w-full px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm border border-border bg-background text-foreground rounded-lg shadow-sm transition-all duration-200 hover:border-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {options.map((option) => (
