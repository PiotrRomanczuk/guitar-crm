...
const sqlFile = fs.readFileSync(
  '/home/piotr/Desktop/guitar-crm/supabase/migrations_v2/030_seed_initial_data.sql',
  'utf8'
);

// Extract INSERT statements for songs
const insertRegex =
  /INSERT INTO songs \(id, title, author, level, key, ultimate_guitar_link, chords\) VALUES \(([^)]+)\)/g;
